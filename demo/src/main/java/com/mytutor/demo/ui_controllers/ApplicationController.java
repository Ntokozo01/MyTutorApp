...
/**
 * Manages applicant capturing of an job application in response to a specified post
 */
@Controller
...
public class ApplicationController {
    ...
    /**
     * Gets the postIdentifier from the url which is the id of the post the applicant is making application for
   ...
   /**
    * Checks whether the postIdentifier is valid and/or the application is still open and fetches the
    * description of the post
     * @param model: models attribute for a new Application form if application is found and the post description
     * @param httpSession: used to setAttribute to show form or not and the result messages
    ...
    /**
     * Receives an Application object from the application form the applicant filled with their details
     * Adds the application to the database and sends an Email for successful capturing with the provided
     * details and how to track their application
     * @param applicant: application form object from the template
     * @param courseList: list of courses and the previous mark as course_code + '##' + course_mark
     * @param httpSession: user session to extract postIdentifier and add result messages for the use application process
